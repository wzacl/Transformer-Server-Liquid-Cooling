...
import Sequence_WindowProcessor_no_air
...
#選擇模型
test_model='multi_seq35_steps8_batch512_hidden8_encoder2_decoder2_heads4_dropout0.005_epoch300'
...
scaler_path = '/home/inventec/Desktop/2KWCDU_修改版本/code_manage/Predict_Model/multi_seq35_steps8_batch512_hidden8_encoder2_decoder2_heads4_dropout0.005_epoch300/1.5_1KWscalers.jlib' 
...
seq_window_processor = Sequence_WindowProcessor_no_air.SequenceWindowProcessor_no_air(
...
while model_tester.phase != "end":
    try:
        ...
        keys = ['timestamp', 'actual_temps(CDU_out)', 'actual_temps(GPU)', 'fan_duty', 'pump_duty', 'predicted_sequence']
        values = [current_time, adam.buffer[3], data[0], adam.buffer[8], adam.buffer[9], predicted_sequence]
